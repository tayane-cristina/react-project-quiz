...
const History = () => {
  ...
  const btnOptionsInitialState = () => {
    ...
    btnOne.style.backgroundColor = 'rgb(226, 186, 7)'
    btnTwo.style.backgroundColor = 'rgb(226, 186, 7)'
    btnThree.style.backgroundColor = 'rgb(226, 186, 7)'
    btnFour.style.backgroundColor = 'rgb(226, 186, 7)'
  }
        ...
        <>
          ...
          <div className='answer-section'>
            {historyQuestions[currentQuestion].answerOptions.map((answerOption, index) => (
              <button className='answer-option-btn history' key={index} onClick={(e) => handleAnswerOptionClick(e, answerOption.isCorrect)}>
